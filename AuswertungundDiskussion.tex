...
Mit der Steigung der Ausgleichsgerade aus Tabelle \ref{tb:steig1} ergibt für das gegebene Thermoelement sich ein Seebeck-Koeffizient von 
\begin{equation}
...
Nun kann man den Peltier-Koeffiezient wie in Kapitel 4.1 bestimmen. Dafür wurde die Thermospannung $U_{\mathrm{Pe}}$ gegen die Temperaturdifferenz $T_{\mathrm{O,U}} - T_{\mathrm{ref}} = T_{\mathrm{O,U}}$, da $ T_{\mathrm{ref}} = 0°C $ist, aufgetragen. Das Ergebniss ist in Abbildung (\ref{letzepls}) zu sehen.
...
\end{equation}
gegeben ist. Somit überschneiden sich diese zwei Ergebnisse auch mit dem Maximalfehler um $0,05 \cdot 10^{-2} \frac{\text{V}}{\text{K}}$ nicht. 